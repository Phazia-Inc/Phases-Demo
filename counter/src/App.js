...
function App() {
  ...
  return (
    <div className="App">
      <h1 className="title">Spice Up the UI!</h1>
      <p className="counter">{count}</p>
      <button className="button" onClick={increment}>Up by 1</button>
      <button className="button" onClick={getServerResponse}>Get Server Response</button>
